...
var _user$project$App$initialModel = {
	photos: {
		ctor: '::',
		_0: {
			url: A2(_elm_lang$core$Basics_ops['++'], _user$project$App$urlPrefix, '1.jpg')
		},
		_1: {
			ctor: '::',
			_0: {
				url: A2(_elm_lang$core$Basics_ops['++'], _user$project$App$urlPrefix, '2.jpg')
			},
			_1: {
				ctor: '::',
				_0: {
					url: A2(_elm_lang$core$Basics_ops['++'], _user$project$App$urlPrefix, '3.jpg')
				},
				_1: {ctor: '[]'}
			}
		}
	},
	selectedUrl: A2(_elm_lang$core$Basics_ops['++'], _user$project$App$urlPrefix, '1.jpg'),
